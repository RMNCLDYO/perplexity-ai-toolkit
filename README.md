...
> [!IMPORTANT]  
> In order to generate an API key for Perplexity, you must first add your payment information to your account. API keys can only be generated when your balance is nonzero.
